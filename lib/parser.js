...
exports.toXml = function(msg, callback) {
  msg = msg.trim();
  if (msg[0] === String.fromCharCode(11)) {
      msg = msg.slice(1);
  }
  ...
  var xml = builder.create(headerComposites[9].split('^')[0], {'version': '1.0', 'encoding': 'UTF-8'}).att('xmlns','urn:hl7-org:v2xml');
  ...
  var xmlString = xml.end({ 'pretty': true, 'indent': '    ', 'newline': '\n' });
    ...
    fs.writeFile('hl7.log', xmlString);
