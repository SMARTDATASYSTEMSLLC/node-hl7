...
function Encoder2() {
    ...
    var encode = function(message) {
        ...
        encodedMessage = String.fromCharCode(11) + segments.join(NEW_LINE) + String.fromCharCode(12,28,13);
    ...
    var encodeSegment = function(name, segment) {
        if (name === 'MSH') {
            ...
            return name + FIELD_SEPARATOR + joinAllFieldsInSparseArrayIntoASingleLine(segment, name);
        }
    };
