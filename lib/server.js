...
function Server(host, port, options) {
    ...
    var applicationAcceptACK = String.fromCharCode(11) + 'MSH|^~\\&|||||20121217154325.194-0700||ACK^RO1|101|T|2.6\nMSA|AA|17'+ String.fromCharCode(13,28,13);
